...
REGISTER './task2udf.py' USING jython AS nulludf;
...
-- Join tables to get necessary fields
...
final_output_data = FOREACH final_combined_data GENERATE
    ...
    nulludf.change_null_val(combined_medal_data::gold_medal_count::gold_count) AS Gold, 
    nulludf.change_null_val(combined_medal_data::silver_medal_count::silver_count) AS Silver;
...
-- Store the result
STORE ordered_final_output INTO '/output/task2-2' USING PigStorage(' ');
